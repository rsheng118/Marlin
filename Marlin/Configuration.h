...
#define STRING_CONFIG_H_AUTHOR "(Robert Sheng Skr1.4 Marlin2.0.7)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 1600, 2634}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 800, 1200 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 1000, 2000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20, 0, -1.53 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 150), (Y_MIN_POS  + 120), 10 }
...
#define RGBW_LED
  ...
  #define RGB_LED_R_PIN       P1_24
  #define RGB_LED_G_PIN       P1_24
  #define RGB_LED_B_PIN       P1_24
  #define RGB_LED_W_PIN      P1_24
#endif
