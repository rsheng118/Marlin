...
#define STRING_CONFIG_H_AUTHOR "(Robert Sheng Skr1.4 Marlin 2.0.7.2)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
   #define DEFAULT_bedKp 1168.07
   #define DEFAULT_bedKi 26.44
   #define DEFAULT_bedKd 712.21
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 1600, 5400}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3200, 3200, 800, 1200 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20, 0, -1.76 } //between -1.46 and -1.66
